...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView1.ViewSize = [2107, 1147]
      renderView1.AxesGrid = 'GridAxes3DActor'
      renderView1.CenterOfRotation = [63.5, 127.5, 127.5]
      renderView1.StereoType = 'Crystal Eyes'
      renderView1.CameraPosition = [1401.1170985642984, 853.3940700374324, 1876.0293507477304]
      renderView1.CameraFocalPoint = [63.49999999999998, 127.49999999999997, 127.49999999999997]
      renderView1.CameraViewUp = [-0.1668259743160398, 0.9492947563637997, -0.26647431364710983]
      renderView1.CameraFocalDisk = 1.0
      renderView1.CameraParallelScale = 191.16681197320835
      ...
      coprocessor.RegisterView(renderView1,
          filename='./gsdata/RenderView1_%t.png', freq=1, fittoscreen=0, magnification=1, width=2384, height=1568, cinema={})
