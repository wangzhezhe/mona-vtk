...
class DWIMPIPipeline : public colza::Backend
{
...
public:
   ...
   * @brief Constructor.
   */
  DWIMPIPipeline(const colza::PipelineFactoryArgs& args)
   ...
   */
  DWIMPIPipeline(DWIMPIPipeline&&) = delete;

  /**
   * @brief Copy-constructor.
   */
  DWIMPIPipeline(const DWIMPIPipeline&) = delete;

  /**
   * @brief Move-assignment operator.
   */
  DWIMPIPipeline& operator=(DWIMPIPipeline&&) = delete;

  /**
   * @brief Copy-assignment operator.
   */
  DWIMPIPipeline& operator=(const DWIMPIPipeline&) = delete;

  /**
   * @brief Destructor.
   */
  virtual ~DWIMPIPipeline() = default;
